...
<div class="text-center" style="width: 400px; background-color: white; padding: 20px; border-radius: 5px; margin: 30px auto 0;">
  <h5>To Check Assignment Status:</h5>
  <form method="get">
    ...
    <h4 class="card-title text-center" style="font-size: 22px;">Assigned Students to Teachers</h4>
</div><!-- end card header -->
              ...
              WHERE NOT EXISTS (SELECT 1 FROM assign WHERE studinfo.PRN = assign.PRN)";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header justify-content-center align-items-center d-flex" style="height: 80px;">
    <h4 class="card-title text-center" style="font-size: 22px;">Assigned Students to Teachers
                                    ...
                                    <div class="button-container">
                                        <a href="Cdep_assign_Report.php?AY=<?php echo $_GET['AY']; ?>&dept=<?php echo urlencode($dept); ?>"
                                    ...
                                    <div class="card-content table-responsive">
                                        <table class="table table-bordered border-dark" id="table">
                                            ...
                                            echo "<thead class='text-primary'>";
                                            echo "<tr>";
                                            echo "<th colspan='7' style='text-align: center;font-size: 18px;'>Total Assigned Students: $count</th>";
                                            echo "</tr>";
                                            echo "</thead>";
                                            ?>
                                            <?php
                                          ...
                                          AND NOT EXISTS (SELECT 1 FROM assign WHERE studinfo.PRN = assign.PRN)";
                                            ...
                                            echo "<thead class='text-primary'>";
                                            echo "<tr>";
                                            echo "<th colspan='7' style='text-align: center;font-size: 18px;'>Students Not Assigned : $count</th>";
                                            echo "</tr>";
                                            echo "</thead>";
                                            ?>
                                            <style>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td style='text-align: center;'>" . "Assigned To" . "</td>";
