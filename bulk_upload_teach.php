...
<head>
    ...
    <meta charset="utf-8" />
    <title>Bluk Upload Teacher</title>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="edit_teacher.php"><i
                                    class="mdi mdi-logout text-muted font-size-16 align-middle me-1"></i> <span
                                    class="align-middle">Teacher Acitivity</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <img src="assets/images/teacher_sample_img.png" alt="Sample Image"><br>
                        <p id="Fourth">Download Format File <a href="assets/samples/CSE_Format_Teacher.xlsx">Click to
                                Download</a></p>
                        <style>
                            #myModal img {
                                max-width: 100%;
        ...
        if (isset($_POST["import"])) {
            ...
            if ($_FILES["file"]["size"] > 0) {
                ...
                while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
                    ...
                    $sqlInsert = "INSERT INTO teachinfo (tName,Department,tPassword) VALUES ('$column[0]', '$column[1]', '$column[2]')";
