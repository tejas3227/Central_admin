                            ...
                            <div class="row">
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted">Bulk Upload Data to Database</p>
                                            </div>

                                            <div class="mt-4">
                                                <a href="bulk_upload_teach.php?dept=<?php echo $_GET['dept']; ?>&AY=<?php echo $_GET['AY']; ?>"
                                                    class="btn btn-primary w-100">Bulk Upload</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card pricing-box">
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                <h5 class="mb-1 font-size-20">Add Teacher</h5>

                                                <p class="text-muted">Add Teacher to the database</p>
                                            </div>

                                            <div class="mt-4">
                                                <a href="teacher_add.php?dept=<?php echo $_GET['dept']; ?>&AY=<?php echo $_GET['AY']; ?>"
                                ...
                                <div class="col-xl-4">
                                    <div class="card pricing-box">
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                <h5 class="mb-1 font-size-20">Remove Teacher</h5>

                                                <p class="text-muted">Remove Teacher from the database</p>
                                            </div>

                                            <div class="mt-4">
                                                <a href="remove_teacher.php?dept=<?php echo $_GET['dept']; ?>&AY=<?php echo $_GET['AY']; ?>"
