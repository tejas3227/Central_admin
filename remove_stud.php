...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "delete from `studinfo` where PRN='$PRN'");

    if (mysqli_affected_rows($conn) > 0) {
        echo "<script>alert('PRN Removed Successfully....');</script>";
    } else {
...
<body data-layout="horizontal" data-topbar="dark">
    ...
    <h4 class="card-title text-center" style="font-size: 22px;">Remove Student</h4>
</div><!-- end card header -->
                            <div class="card-body">
