...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO `studinfo` (PRN,Name,Department,Class,Password)
      VALUES ('$PRN','$Name','$Department','$Class','$Password')");

    if (mysqli_affected_rows($conn) > 0) {
        echo "<script>alert('PRN Added Successfully....');</script>";
    } else {
...
<body data-layout="horizontal" data-topbar="dark">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-toggle arrow-none"
                                            ...
                                            <span data-key="t-dashboard">Student Activity</span>
                                        </a>
                                    </li>
    ...
    <h4 class="card-title text-center" style="font-size: 22px;">Add Student</h4>
</div><!-- end card header -->
                            <div class="card-body">
                                <form action="#" method="post">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="academic_year" class="form-control"
                                                ...
                                                value="<?php echo $_GET['AY'] ?>" readonly>
                                        </div>
                                    </div><!-- end row -->

                                    <div class="row mb-4">
                                        <label for="sprn" class="col-sm-3 col-form-label">Student PRN</label>
                                        <div class="col-sm-4">
                                            <input type="number" name="sprn" class="form-control" id="sprn"
                                                placeholder="Enter Student PRN">
                                        </div>
                                    </div><!-- end row -->

                                    <div class="row mb-4">
                                        <label for="sn" class="col-sm-3 col-form-label">Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="sn" class="form-control" id="spass"
                                                placeholder="Enter Name">
                                        </div>
                                    </div><!-- end row -->

                                    <div class="row mb-4">
                                        <label for="scl" class="col-sm-3 col-form-label">Class</label>
                                        <div class="col-sm-4">
                                            <select name="scl" class="form-control" id="scl">
                                    ...
                                    <div class="row mb-4">
                                        <label for="sd" class="col-sm-3 col-form-label">Department</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="row mb-4">
                                        <label for="spass" class="col-sm-3 col-form-label">Password</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="spass" class="form-control" id="spass"
