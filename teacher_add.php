...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "insert into `teachinfo` (tid,tName,Department,tPassword)
      values ('$TID','$Name','$Department','$Password')");

    if (mysqli_affected_rows($conn) > 0) {
        echo "<script>alert('TID Added Successfully....');</script>";
    } else {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="#" method="post">
                                    ...
                                    <div class="row mb-4">
                                        <label for="tn" class="col-sm-3 col-form-label">Teacher Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="tn" class="form-control" id="tn"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="td" class="form-control" id="td"
                                                value="<?php echo $_GET['dept'] ?>" placeholder="Enter Department"
                                                readonly>
                                        </div>
                                    </div><!-- end row -->

                                    <div class="row mb-4">
                                        <label for="tpass" class="col-sm-3 col-form-label">Password</label>
                                        <div class="col-sm-4">
                                            <input type="text" name="tpass" value="kitcoek" class="form-control"
                                                id="tpass" placeholder="Enter Password" readonly>
                                        </div>
                                    </div><!-- end row -->
