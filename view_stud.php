                        ...
                        <div class="topnav">
                            <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                ...
                                <div class="collapse navbar-collapse" id="topnav-menu-content">
                                    <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-toggle arrow-none" href="year_select.php?dept=<?php echo $_GET['dept'];?>&AY=<?php echo $_GET['AY']; ?>" id="topnav-dashboard" role="button"
...
<div class="card-header justify-content-between d-flex align-items-center">
    <form method="GET" action="view_stud.php" class="d-flex justify-content-center">
        <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Search PRN" name="searchInput" value="<?php echo htmlspecialchars($_GET['searchInput'] ?? '', ENT_QUOTES); ?>">
            <input type="hidden" name="dept" value="<?php echo $_GET['dept']; ?>">
            ...
            <div class="main-content">
               ...
               ?>
                ...
                <tr>
                    ...
                    <td><?php echo  $show['Mobile_Number']; ?></td>
                    <td><?php echo  $show['Alt_Mobile_Number']; ?></td>
...
<a href="excel_stud.php?dept=<?php echo $dept ?>&academic_year=<?php echo $academic_year ?>">Download Excel File</a><br>
